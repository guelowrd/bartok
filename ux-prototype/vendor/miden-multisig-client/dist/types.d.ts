...
export type { Signer, FalconSignature, EcdsaSignature, ProposalSignature, SignatureScheme, CosignerSignature, AuthConfig, DeltaStatus, DeltaObject, StateObject, ConfigureRequest, ConfigureResponse, PubkeyResponse, DeltaProposalRequest, DeltaProposalResponse, ProposalsResponse, SignProposalRequest, } from '@openzeppelin/guardian-client';
export type { ExportedProposal, ExportedTransactionProposal, Proposal, ProposalMetadata, ProposalSignatureEntry, ProposalStatus, ProposalType, SignTransactionProposalParams, TransactionProposal, TransactionProposalSignature, TransactionProposalStatus, } from './types/proposal.js';
...
export type TransactionType = {
    ...
    type: 'updateSigners';
    newThreshold: number;
    newSignerCommitments: string[];
} | {
    type: 'updateProcedureThreshold';
    procedure: ProcedureName;
    threshold: number;
};

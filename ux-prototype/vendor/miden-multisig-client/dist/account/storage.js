...
export function buildMultisigStorageSlots(config) {
    return defaultStorageBuilder.buildMultisigSlots(config);
}
export function buildGuardianStorageSlots(config) {

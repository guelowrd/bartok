import { AccountId, FeltArray, FungibleAsset, MidenArrays, Note, NoteAssets, NoteMetadata, NoteRecipient, NoteScript, NoteStorage, NoteTag, NoteType, Poseidon2, TransactionRequestBuilder, Word as WordType, } from '@miden-sdk/miden-sdk';
import { randomWord } from '../utils/random.js';
import { normalizeHexWord } from '../utils/encoding.js';
export function deriveP2idSerialNumber(salt) {
...
function buildP2idNote(sender, recipient, noteAssets, noteType, saltHex) {
    ...
    const noteMetadata = new NoteMetadata(sender, noteType, noteTag);
    return new Note(noteAssets, noteMetadata, noteRecipient);
}
export function buildP2idTransactionRequest(senderId, recipientId, faucetId, amount, options = {}) {
    ...
    const note = buildP2idNote(sender, recipient, noteAssets, NoteType.Public, authSaltHex);
